...
/**
 * This is an example class showing how to use the EthosErrorClient to retrieve errors from Ethos Integration.
 */
public class EthosErrorsClientExample {
    ...
    /**
     * Builds and returns an EthosErrorsClient using the API key and timeout values.
     * @return An EthosErrorClient.
     */
    ...
    /**
     * This example shows how to retrieve the headers from the EthosResponse obtained from a call to get errors.
     */
    ...
    /**
     * This example shows how to retrieve an initial page of errors accessing the response bodies from the EthosResponse using JsonNode.
     */
    ...
    /**
     * This example shows how to retrieve an initial page of errors directly as JsonNodes from the EthosErrorsClient.
     */
    ...
    /**
     * This example shows how to retrieve an initial page of errors directly as a JSON formatted string.
     */
    ...
    /**
     * This example shows how to get an initial page (list) of EthosErrors objects.
     */
    ...
    /**
     * This example shows how to get an error by ID (GUID).
     */
    ...
    /**
     * This example shows how to get an error by ID as an EthosError object.
     */
    ...
    /**
     * This example shows haw to get an error by ID directly as a Jackson JsonNode.
     */
    ...
    /**
     * This example shows how to get an error by ID as a JSON formatted string.
     */
    ...
    /**
     * This example shows how to add a new error using a POST request through the EthosErrorClient.
     */
...
//    }
    ...
    /**
     * This example shows how paging works when retrieving errors.
     */
    public void getErrorsFromOffsetWithPageSize() {
        ...
        try {
            ...
            // Each response in the list represents a page of errors.
            ...
            for( int pageCount = 0; pageCount < ethosResponseList.size(); pageCount++ ) {
                ...
                // Each response (page) contains a list of errors.
